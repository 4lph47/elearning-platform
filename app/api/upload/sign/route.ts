...
// Documentos e trailers de curso — vídeo de AULA vai direto pro worker
// agora (ver /api/upload/authorize-direct); trailer fica aqui porque o
// hover-preview (CourseTile.tsx) usa <video> simples, sem hls.js, então
// não faz sentido processar em HLS. Imagens continuam a passar por
// app/api/upload (precisam de compressão server-side com sharp, e são
// pequenas o suficiente para caberem no limite de corpo do Vercel).
const ALLOWED_KINDS = ["DOCUMENT", "TRAILER"] as const;
